package io.mctest.agent.serverforge.truth;
 ...
 * {@link Names#lookupStateProvider()} (a {@link java.util.ServiceLoader} lookup — the Forge discovery
 ...
 *       core).</li>
 *   <li><b>Fallback grammar</b> (when no provider is registered): a vanilla Forge server exposes no
...
public final class PluginStateProbe {
    ...
    private Object resolve(String query, Map<String, Object> args) throws McTestException {
        ...
        // DOWNLOADED mod (no McTestStateProvider) can still be asserted present. Forge presence is
        ...
        // Forge server has no Bukkit-style config/perms fallback, so the query is unknown.
