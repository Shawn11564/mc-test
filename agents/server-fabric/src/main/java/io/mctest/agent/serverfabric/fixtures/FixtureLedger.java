 ...
 * game types/Gson) so the undo bookkeeping — the bit most likely to rot — is unit-testable in isolation.
 *
 ...
 *
 * <p>Copied verbatim from the {@code server-bukkit} agent (pure Java). Do not re-derive — reuse.
 */
