// mc-test server-neoforge agent — STANDALONE Gradle build (NOT part of agents/settings.gradle.kts).
//
// This shim is a NeoForge mod that needs the Minecraft toolchain + network (NeoForge + Mojmap mappings,
// a real dedicated server). It is therefore kept OUT of the `mc-test-agents` build so that
...
rootProject.name = "mc-test-server-neoforge"
