package io.mctest.agent.serverneoforge.truth;
 ...
 * {@link Names#lookupStateProvider()} (a {@link java.util.ServiceLoader} lookup — the NeoForge discovery
 ...
 *       core).</li>
 *   <li><b>Fallback grammar</b> (when no provider is registered): a vanilla NeoForge server exposes no
...
public final class PluginStateProbe {
    ...
    private Object resolve(String query, Map<String, Object> args) throws McTestException {
        ...
        // DOWNLOADED mod (no McTestStateProvider) can still be asserted present. NeoForge presence is
        // ModList.get().isLoaded (quarantined behind Names).
        ...
        // NeoForge server has no Bukkit-style config/perms fallback, so the query is unknown.
