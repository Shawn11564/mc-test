// mc-test client-forge agent — STANDALONE Gradle build (NOT part of agents/settings.gradle.kts).
//
// This shim is a ForgeGradle mod that needs the Minecraft toolchain + network (MCP/official mappings,
// the Forge userdev, a real client). It is therefore kept OUT of the `mc-test-agents` build so that
...
rootProject.name = "mc-test-client-forge"
