...
/**
 * The OpenRegions list Screen (title "Regions") — the CRUD surface of the Forge SUT, mirroring the
 * Fabric {@code RegionsListScreen}.
 *
 ...
 * them; the server-truth half is seeded separately via a fixture. A plain Forge mod with no mc-test
